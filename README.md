...
각 기능에 대한 예시 UI를 첨부하였다.
  <BR> <img src="https://github.com/haewon13/AgingAPP/blob/master/UI/intro.jpg" width="100" height="300"><BR>
  <BR>![title](UI/intro.jpg){: width="100" height="300"), ![Alt text](UI/main_menu.jpg) ![Alt text](UI/main_menu.jpg) <BR>
